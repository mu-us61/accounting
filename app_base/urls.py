...
urlpatterns = [
    ...
    # //------------------------~~--------------------------------------------------------------------------
    path("grouplist/", views.GroupListView.as_view(), name="grouplist_view_name"),
    path("grouplistmasked/", views.GroupListMaskedView.as_view(), name="grouplistmasked_view_name"),
